...
This pipeline make use of several external databases, you will have to modify the path of those in the `nextflow.config`file, so it corresponds to your system (OR you can provide those in the running command, but that is certainly more combersom).
