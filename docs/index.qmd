...
It is possible that some tracks do not work as intended (eg. reorganisation modules, change of name).
If you attempt to use this pipeline, please let us now if it not working or of anything that is weird (scientifically and bioinformatically).
