...
Haploid assembly (or as near as possible is required for this variant calling track).
We use [FREEBAYES] variant mapper for variant calling. **We recommend to read FREEBAYES instructions carefully to understand what has been done (an not) here**
...
- QUAL: probability that there is a polymorphism at the loci described by the record.
  $1 - P_{locus\ is\ homozygous\ given\ the\ data}$
  [GQ, when supplying --genotype-qualities]
